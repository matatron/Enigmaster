                        ...
                        <div class="panel-body noscroll-height">
                            ...
                            <table class="table table-hover table-condensed ">
                                <tr ng-repeat="clue in ctrl.clues" ng-class="{'success': clue.sent}">
                                    <td>
                                        <button class="btn btn-default btn-xs" type="button" ng-click="ctrl.copyClue(clue, false);" uib-tooltip="Editar antes de enviar" tooltip-placement="auto right"><i class="fa fa-chevron-up" aria-hidden="true"></i></button>
                                    </td>
                                    <td>{{clue.value}}</td>
                                    <td class="text-right">
