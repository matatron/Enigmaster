        ...
        <div ng-show="screen=='menuHex'">
            ...
            <div class="section4 futurepanel" ng-show="section=='section4'">
                ...
                <div class="futurepanel__body" style="font-size: 3em; line-height: 1.5em">
                    <div ><span class="alien colorY">Y</span> + <span class="alien colorY">Y</span> + <span class="alien colorY">Y</span> = <span class="alien sum" ng-hide="sumas == 'visible'">E</span> <span class="sum" ng-show="sumas == 'visible'">15</span></div>
                    <div><span class="alien colorZ">Z</span> + <span class="alien colorW">W</span> + <span class="alien colorW">W</span> = <span class="alien sum" ng-hide="sumas == 'visible'">O</span> <span class="sum" ng-show="sumas == 'visible'">11</span></div>
                    <div><span class="alien colorZ">Z</span> + <span class="alien colorW">W</span> + <span class="alien colorY">Y</span> = <span class="alien sum" ng-hide="sumas == 'visible'">M</span> <span class="sum" ng-show="sumas == 'visible'">14</span></div>
                    <div><span class="alien colorX">X</span> + <span class="alien colorW">W</span> + <span class="alien colorY">Y</span> = <span class="alien sum" ng-hide="sumas == 'visible'">U</span> <span class="sum" ng-show="sumas == 'visible'">10</span></div>
                </div>
            </div>
